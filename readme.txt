...
4. Create a communication between the two pages (using protocol=”http” and port number  8000) and check whether the user requested the home page or any other page
5. If the user requests any other page other than the above two, then redirect to homepage 
